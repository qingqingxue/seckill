...
public class SeckillServiceImpl implements SeckillService {
    ...
    //随机敲的，用以混淆md5
    private final String slat="sfsdfgdrtrei*8tr9htyudfdv454detrte";
    @Override
    ...
    /**
     * 使用注解控制事务方法的优点
     * 1.开发团队达成一致约定：明确标注方法的编程方格
     * 2.保证事务方法的执行时间尽可能短，不要穿插其他的网络操作RPC/HTTP 请求或者剥离到事务方法外部
    ...
    public SeckillExcution executeSeckill(long seckillId, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillCloseException {
       ...
       try{
           ...
           if(updateCount <= 0 ){  //没有记录可更新了，说明秒杀结束
               ...
               if(insertCount <= 0){
                   ...
                   return new SeckillExcution(seckillId, SeckillStateEnum.SUCCESS,"秒杀成功",successKilled);
               }
           }
